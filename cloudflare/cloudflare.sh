...
auth_email="phamnhutcongviec@gmail.com"                                       # The email used to login 'https://dash.cloudflare.com'
auth_method="global"                                 # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key="712bcc9bb4b5dd8a7844a8171e38dc64cb6c0"                                         # Your API Token or Global API Key
zone_identifier="65d9e29b568da80e70cd22c35e7d8a2e"                                  # Can be found in the "Overview" tab of your domain
record_name="www.daivietnhanvat.site"                                      # Which record you want to be synced
